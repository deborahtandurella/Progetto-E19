...
public class CustomizationMenuGUI extends AbstractMenuGUI {
    ...
    public CustomizationMenuGUI(GameContainer container, Screen screen, CustomizationMenu state) throws SlickException {
        ...
        batmanButton = new MouseOverArea(container, batman, container.getWidth()/2 - 3*buttonWidth/2, 30*container.getHeight()/100, buttonWidth, buttonHeight, this);
        Image dogo = new Image("res/sprites/customTextures/dogo/dogo.png").getScaledCopy(buttonWidth,buttonHeight);
        dogoButton = new MouseOverArea(container, dogo, container.getWidth()/2 - buttonWidth/2, 30*container.getHeight()/100, buttonWidth, buttonHeight, this);
        Image bird = new Image("res/sprites/player/bird.png").getScaledCopy(buttonWidth,buttonHeight);
        classicButton = new MouseOverArea(container, bird, container.getWidth()/2 - 5*buttonWidth/2, 30*container.getHeight()/100, buttonWidth, buttonHeight, this);
        Image fish = new Image("res/sprites/customTextures/sea/fish.png").getScaledCopy(buttonWidth,buttonHeight);
        seaButton = new MouseOverArea(container, fish, container.getWidth()/2 + 3*buttonWidth/2, 30*container.getHeight()/100, buttonWidth, buttonHeight, this);
        Image blueBird = new Image("res/sprites/customTextures/sky/bird.png").getScaledCopy(buttonWidth,buttonHeight);
        skyButton = new MouseOverArea(container, blueBird, container.getWidth()/2 + buttonWidth/2, 30*container.getHeight()/100, buttonWidth, buttonHeight, this);
